...
function handleDrop(e) {
  ...
  if (dragSrcEl != this) {
    ...
    if(this.innerHTML != "_____________________________")$('#' + this.id).show();
    ...
    $(this).click(function(){  
      ...
      this.id = ''; 
      this.innerHTML = '_____________________________'; 
...
function addDragDropBehaviour(cb){
  ...
  [].forEach.call(cols, function(col) {
    ...
    col.addEventListener('drop', cb, false);
