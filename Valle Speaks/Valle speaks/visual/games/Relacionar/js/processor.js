...
function BuiltCards(){
	...
	shuffle(respArray).forEach(function(e, index){			
		resp+="<div class='d-inline-block'><h3><span id='word-"+(index + 1)+"' draggable='true' class='drag-markup move badge badge-normal rounded px-2 my-1 mx-1'>"+e.substring(1, e.length - 1)+"</span></h3></div>"
	});	
