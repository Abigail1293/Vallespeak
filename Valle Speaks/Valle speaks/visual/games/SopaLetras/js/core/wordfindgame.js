	...
	var r=function(){
		...
		u=function(e,n){
				for(var r="<ul>",o=0,a=n.length;a>o;o++){
					var l=n[o]; //<h3><span class='"+l+"badge badge-normal rounded px-2 my-1 mx-1'>"+l+"</span></h3>
					//r+='<li class="word '+l+'">'+l
					r+="<h5><span class='word "+l+" badge badge-normal rounded px-2 my-1 mx-1'>"+l+"</span></h5>"
				}
				r+="</ul>",
				t(e).html(r)
		},
		...
		z=function(){
			...
			for(var e=0,n=r.length;n>e;e++)
				r[e]===i&&(
						cnd?t(".selected").addClass("found"): t(".selected").addClass(""),		
						cnd?r.splice(e,1): r,
						cnd?t("."+i).addClass("wordFound"):t("."+i).addClass("")									
					),
