...
var nwdialog = {
    ...
    _context: typeof global.DOMDocument === 'undefined' ? null : global.DOMDocument,
    ...
    saveFileDialog: function(name, accept, directory, callback) {
        ...
        var fn          = callback;
        var node        = this._context.getElementById("save-file-dialog")==null?this._context.createElement('input'): this._context.getElementById("save-file-dialog");
        node.type       = 'file';
